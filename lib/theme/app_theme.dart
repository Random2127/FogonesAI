...
final ThemeData darkMode = ThemeData(
  // Vamos a ver si furula el tema oscuro, no tengo mucha fe pero vamos a intentarlo
  ...
  colorScheme: const ColorScheme(
    brightness: Brightness.dark,
    primary: Color(0xFFD8A373), // Soft honey
    onPrimary: Color(0xFF2B2520),
    secondary: Color(0xFF9C8A72), // Muted clay
...
final ThemeData lightMode = ThemeData(
  ...
  colorScheme: const ColorScheme(
    brightness: Brightness.light,
    primary: Color(0xFFC97A4A), // Muted terracotta
    onPrimary: Colors.white,
    secondary: Color(0xFFB8A58D), // Warm beige
